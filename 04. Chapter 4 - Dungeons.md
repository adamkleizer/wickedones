...
[note]: # (the symbol to the right is explained in parenthesis next to the sentence mentioning it)
...
[note]: # (drawings of the basic and detailed style are here in the book)
...
[note]: # (example map here in the book)
